          ...
          <div class="col-lg-12">
			...
			<div class="card card-info">
              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    <label for="InputNumbervalidte4">API Key</label>
				    <input id="InputNumbervalidte4" type="text" name="API Key" class="form-control" placeholder="Enter API Key">
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
			...
			<div class="card card-info">
			  <!-- card-header -->
              <div class="card-header">
                <h3 class="card-title">Admin Alert</h3>
              </div>
              <!-- card-header -->
              <div class="card-header bg-light">
			...
			<div class="card card-info">
              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    <label for="InpuTitleNotification">Title Notification</label>
				    <input id="InputTitleNotification" type="text" name="TitleNotification" class="form-control" placeholder="Enter TitleNotification">
                  </div>
                  <div class="form-group">
                    <label for="InputBodyNotification">Body Notification</label>
				    <input id="InputBodyNotification" type="text" name="BodyNotification" class="form-control" placeholder="Enter BodyNotification">
                  </div>				  
                  <div class="form-group">
                    <label for="InputIconNotification">Icon Notification</label>
				    <input id="InputIconNotification" type="text" name="IconNotification" class="form-control" placeholder="Enter Icon Notification">
                  </div>
                  <div class="form-group">
                    <label for="InpuImageNotification">Image Notification</label>
				    <input id="InputImageNotification" type="text" name="ImageNotification" class="form-control" placeholder="Enter Image Notification">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="InputClick_Action">Click Action</label>
				    <input id="InputClick_Action" type="text" name="Click_Action" class="form-control" placeholder="Enter Click Action">
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
			...
			<div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Confirm Slide & Badges</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                  <div class="form-group">
                    <label for="InpuConfirmSlide">Confirm Slide</label>
				    <input id="InputConfirmSlide" type="number" min="1" max="50" name="ConfirmSlide" class="form-control" placeholder="Enter Confirm Slide">
                  </div>
                  <div class="form-group">
                    <label for="InputBadge1">Badge1</label>
				    <input id="InputBadge1" type="number" min="1" max="50" name="Badge1" class="form-control" placeholder="Enter Badge1 Points">
                  </div>				  
                  <div class="form-group">
                    <label for="InputBadge2">Badge2</label>
				    <input id="InputBadge2" type="number" min="1" max="50" name="Badge2" class="form-control" placeholder="Enter Badge2 Points">
                  </div>
                  <div class="form-group">
                    <label for="InpuBadge3">Badge3</label>
				    <input id="InputBadge3" type="number" min="1" max="50" name="Badge3" class="form-control" placeholder="Enter Badge3 Points">
                  </div>
                  <div class="form-group">
                    <label for="InputBadge4">Badge4</label>
				    <input id="InputBadge4" type="number" min="1" max="50" name="Badge4" class="form-control" placeholder="Enter Badge4 Points">
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
...
<h5 class="text-muted">Select type</h5>
	...
	<div class="form-group" id="slotUsers">
	<label>Number of users for slot?</label>
